...
const getAllReviews = async (req, res) => {
  try {
    const reviews = await Review.find()
      ...
      .populate("username", "fullname email") // adjust based on your User model
      .populate("turfname", "turfname address"); // adjust based on your Turf model
...
module.exports = {
  ReviewRating, deleteReview,getReviews,getAllReviews
};
