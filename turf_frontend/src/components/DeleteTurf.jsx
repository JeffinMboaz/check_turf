...
function DeleteTurf({ show, handleClose, turfOptions, onSubmit }) {
...
useEffect(() => {
  ...
  return (
    <div>
      ...
      <Modal.Header closeButton>
        <Modal.Title>Delete Turf</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <Form>
  ...
  <Form.Control type="text" name="turfname" value={formData.turfname} onChange={handleChange} />
      ...
      <Modal.Footer>
        ...
        <Button variant="dark" onClick={handleSubmit}>Delete Turf</Button>
      </Modal.Footer>
    </Modal>
    </div>
  )
