...
//       <h2 className="mb-3">My Turf Bookings</h2>
...
//               <input type="text" className="form-control" placeholder="Turf Name" required
//                 value={formData.turfname} onChange={(e) => setFormData({ ...formData, turfname: e.target.value })} />
//             </div>
//             <div className="col-md-4">
//               <input type="text" className="form-control" placeholder="Event" required
//                 value={formData.eventSelected} onChange={(e) => setFormData({ ...formData, eventSelected: e.target.value })} />
//             </div>
//             <div className="col-md-4">
...
//                 value={formData.hours} onChange={(e) => setFormData({ ...formData, hours: parseInt(e.target.value) })} />
//             </div>
//             <div className="col-md-3">
...
//             </div>
//             <div className="col-md-3">
//               <input type="time" className="form-control" placeholder="Start Time" required
//                 value={formData.startTime} onChange={(e) => setFormData({ ...formData, startTime: e.target.value })} />
//             </div>
//             <div className="col-md-3">
//               <input type="time" className="form-control" placeholder="End Time" required
...
//             </div>
//             <div className="col-md-3">
//               <button type="submit" className="btn btn-success mt-2">Submit Booking</button>
//             </div>
//           </div>
//         </form>
//       )}
